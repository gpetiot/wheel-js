...
import { prepareWheelSlices, getSliceAtIndicator, verifyResult } from './utils/testUtils';
    ...
    edgeCases.forEach(edgeCase => {
      test(`${edgeCase.description} (${edgeCase.rotation}°)`, () => {
        ...
        const { startAngle, endAngle } = {
          ...
          endAngle:
            (((wheelSlices[componentResult].rotate - edgeCase.rotation) % 360) +
              wheelSlices[componentResult].sliceAngle) %
            360,
        };
